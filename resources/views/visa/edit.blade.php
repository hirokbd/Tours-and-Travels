...
@section('content')
    <div class="row">
        ...
        <div class="col-12 col-lg-12 grid-margin">
            <div class="card">
                <div class="card-body">
                    <h2 class="card-title">{{ __('Edit Visa Application') }}</h2>
                    ...
                    <form role="form" class="forms-sample" action="{{route('visa.update',[$visaId->id])}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-6 col-12">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="js-example-basic-single form-control" id="client_id" name="client_id" style="width:100%">
                                            ...
                                            @foreach($client_id as $cl_id)
                                                <option value="{{$cl_id->id}}" {{$visaId->client_id == $cl_id->id ? "selected" : "" }}>{{$cl_id->name}}</option>
                                            @endforeach
                                    ...
                                    <div class="col-sm-8">
                                        <select class="js-example-basic-single form-control" id="country_id" name="country_id" style="width:100%">
                                            ...
                                            @foreach($country_id as $cun_id)
                                                <option value="{{$cun_id->id}}" {{$visaId->country_id == $cun_id->id ? "selected" : "" }}>{{$cun_id->name}}</option>
                                            @endforeach
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="app_date" value="{{ $visaId->app_date }}" class="form-control p-input datepicker" id="app_date" placeholder="Enter Application Date">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="down_payment" class="col-sm-4 col-form-label">{{ __('Down Payment') }}</label>
                                    <div class="col-sm-4">
                                        <input type="number" name="down_payment" value="{{ $visaId->down_payment }}" class="form-control p-input" id="down_payment" placeholder="Down Payment">
                                    </div>
                                    <div class="col-sm-4">
                                        <select class="js-example-basic-single form-control" id="down_payment_type" name="down_payment_type" style="width:100%">
                                            @foreach($payment_id as $pay_id)
                                                <option value="{{$pay_id->id}}" {{$visaId->down_payment_type == $pay_id->id ? "selected" : "" }}>{{$pay_id->name}}</option>
                                            @endforeach
                                ...
                                <div class="form-group row">
                                    <label for="document" class="col-sm-4 col-form-label">{{ __('Document') }} <br> @if ($visaId->document) <img src="{{ asset('uploads/documents/'.$visaId->document) }}" height="60"> @endif</label>
                                    <div class="col-sm-8">
                                        <input type="file" name="document" id="document" class="dropify custom-file-input" data-height="80" data-max-file-size="2048kb" />
                                        <input type="hidden" name="hidden_image" value="{{ $visaId->document }}" />
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6 col-12">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="js-example-basic-single form-control" id="visa_type" name="visa_type" style="width:100%">
                                            ...
                                            @foreach($visa_id as $vs_id)
                                                <option value="{{$vs_id->id}}" {{$visaId->visa_type == $vs_id->id ? "selected" : "" }}>{{$vs_id->name}}</option>
                                            @endforeach
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="visa_duration" value="{{ $visaId->visa_duration }}" class="form-control p-input" id="visa_duration" placeholder="Enter Duration">
                                    </div>
                                    <div class="col-sm-4">
                                        <select class="js-example-basic-single form-control" id="visa_duration_type" name="visa_duration_type" style="width:100%">
                                            <option value="Days" {{$visaId->visa_duration_type == 'Days' ? "selected" : "" }}>Days</option>
                                            <option value="Weeks" {{$visaId->visa_duration_type == 'Weeks' ? "selected" : "" }}>Weeks</option>
                                            <option value="Months" {{$visaId->visa_duration_type == 'Months' ? "selected" : "" }}>Months</option>
                                            <option value="Years" {{$visaId->visa_duration_type == 'Years' ? "selected" : "" }}>Years</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="processing_time" value="{{ $visaId->processing_time }}" class="form-control p-input" id="processing_time" placeholder="Enter Processing Time">
                                    </div>
                                    <div class="col-sm-2">
                                        <p>Days</p>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="number" name="app_fee" value="{{ $visaId->app_fee }}" class="form-control p-input" id="app_fee" placeholder="Application Fee">
                                    </div>
                                    <div class="col-sm-4">
                                        <select class="js-example-basic-single form-control" id="app_fee_type" name="app_fee_type" style="width:100%">
                                            @foreach($payment_id as $pay_id)
                                                <option value="{{$pay_id->id}}" {{$visaId->app_fee_type == $pay_id->id ? "selected" : "" }}>{{$pay_id->name}}</option>
                                            @endforeach
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control" rows="4" name="remarks" id="remarks" placeholder="Enter Remarks">{{ $visaId->remarks }}</textarea>
                                    </div>
                                </div>
